...
while i_main <= max_order_elem:
    with open(f'scordelis_p_ref_displm_p_{i_main}.dat', 'w') as result:
        pass
    if i_main==1:
    ...
    while j_main <= max_number_elem:
        ...
        for p_main in range(number_load_step):
            ...
            while (error / global_load_incr_bc_norm) >= error_force \
                ...
                print(node_displ_all[0, 0, dim -1, 0, 0, 2])
            ...
            with open(f'scordelis_p_ref_displm_p_{i_main}.dat', 'a') as result:
