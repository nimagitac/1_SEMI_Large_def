...
def global_stiffness_matrix(lobatto_pw, element_boundaries_u,\
                            element_boundaries_v,  x_0_coor_all,\
                            nodal_coorsys_all, jacobian_all, node_displ_all,\
    ...
    for i_main in range(number_element_v):
        for j_main in range(number_element_u):
            ...
            k_element = esmlrg.element_stiffness_mtx_mp(lobatto_pw, elem_x_0_coor_all, \
...
if __name__ == '__main__':
    ...
    lobatto_pw_all =esmlrg.lbto_pw("node_weight_all.dat")
    i_main = 4
    if i_main == 1:
    ...
    k_global_bc = esmlrg.stiffness_matrix_bc_applied(k_global, bc1) 
